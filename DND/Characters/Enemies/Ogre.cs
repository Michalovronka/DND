...
public class Ogre : Enemy
{
    ...
    private const int MaxY = Room.RoomHeight - 6;
    private const int MinX = 6;
    private const int MaxX = Room.RoomWidth - 6;

    public Ogre(int hp, int dmg, Room currentRoom, CharacterTypes characterType, int movementSpeed, int moveTurn,
        int attackTurn) : base(hp, dmg, currentRoom, characterType, movementSpeed)
    {
        MoveTurn = moveTurn;
    ...
    public override void Attack(Player player)
    {
        ...
        if (num == 1)
        {
            ...
            if (CurrentRoom.RoomInfo[Position[0] + 2, Position[1]] == 0) CurrentRoom.RoomInfo[Position[0] + 2, Position[1]] = 7;
            if (CurrentRoom.RoomInfo[Position[0] + 2, Position[1]+1] == 0) CurrentRoom.RoomInfo[Position[0] + 2, Position[1]+1] = 7;
            if (CurrentRoom.RoomInfo[Position[0] + 2, Position[1]-1] == 0) CurrentRoom.RoomInfo[Position[0] + 2, Position[1]-1] = 7;
            if (CurrentRoom.RoomInfo[Position[0] - 1, Position[1]] == 0) CurrentRoom.RoomInfo[Position[0] - 1, Position[1]] = 7;
            if (CurrentRoom.RoomInfo[Position[0] - 2, Position[1]] == 0) CurrentRoom.RoomInfo[Position[0] - 2, Position[1]] = 7;
            if (CurrentRoom.RoomInfo[Position[0] - 2, Position[1]+1] == 0) CurrentRoom.RoomInfo[Position[0] - 2, Position[1]+1] = 7;
            ...
            if (
                ...
                CurrentRoom.RoomInfo[Position[0] + 2, Position[1]] == playerInfo ||
                CurrentRoom.RoomInfo[Position[0] + 2, Position[1] + 1] == playerInfo ||
                CurrentRoom.RoomInfo[Position[0] + 2, Position[1] - 1] == playerInfo ||
                CurrentRoom.RoomInfo[Position[0] - 1, Position[1]] == playerInfo ||
                CurrentRoom.RoomInfo[Position[0] - 2, Position[1]] == playerInfo ||
                CurrentRoom.RoomInfo[Position[0] - 2, Position[1] + 1] == playerInfo ||
        ...
        if (CurrentRoom.RoomInfo[Position[0], Position[1] + 2] == 0) CurrentRoom.RoomInfo[Position[0], Position[1] + 2] = 7;
        if (CurrentRoom.RoomInfo[Position[0] + 1, Position[1] + 2] == 0) CurrentRoom.RoomInfo[Position[0] + 1, Position[1] + 2] = 7;
        if (CurrentRoom.RoomInfo[Position[0] - 1, Position[1] + 2] == 0) CurrentRoom.RoomInfo[Position[0] - 1, Position[1] + 2] = 7;
        if (CurrentRoom.RoomInfo[Position[0], Position[1] - 1] == 0) CurrentRoom.RoomInfo[Position[0], Position[1] - 1] = 7;
        if (CurrentRoom.RoomInfo[Position[0], Position[1] - 2] == 0) CurrentRoom.RoomInfo[Position[0], Position[1] - 2] = 7;
        if (CurrentRoom.RoomInfo[Position[0] + 1, Position[1] - 2] == 0) CurrentRoom.RoomInfo[Position[0] + 1, Position[1] - 2] = 7;
        ...
        if (
            ...
            CurrentRoom.RoomInfo[Position[0], Position[1] + 2] == playerInfo ||
